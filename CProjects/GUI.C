...
display_icons()
{
	load_icon ( "gdel.icn", 51, 45 ) ;
	load_icon ( "gren.icn", 141, 45 ) ;
	load_icon ( "gcmp.icn", 231, 45 ) ;
	load_icon ( "genc.icn", 51, 125 ) ;
	load_icon ( "gdec.icn", 141, 125 ) ;
	load_icon ( "gdos.icn", 231, 125 ) ;
}
